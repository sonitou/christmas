...
function createGift() {
    ...
    const messages = [
        "💖 Chúc em bé Thu Nguyệt có một giáng sinh an lành, vui vẻ và hạnh phúc ạ",
        "💖 Em là điều tuyệt vời nhất trong cuộc đời anh!",
        "🌹 Mỗi ngày có em đều là một ngày đáng nhớ.",
        "✨ Em là ánh sáng rực rỡ nhất trong cuộc đời anh.",
        "😍 Chỉ cần có em, thế giới này trở nên hoàn hảo.",
        "💌 Em là lý do khiến mỗi ngày của anh thêm ý nghĩa.",
        "🌷 Gặp em là may mắn lớn nhất đời anh.",
        "✨ Nụ cười của em làm tan biến mọi âu lo.",
        "❤️ Bên em, anh tìm thấy cả thế giới.",
        "🌹 Em không chỉ là người anh yêu, mà là cả giấc mơ của anh.",
    ];
